<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Merchant\Status\merchants-merchantId-status.php
...
$ch = curl_init();
curl_setopt_array($ch, [
    CURLOPT_URL => "https://merchant-api.ifood.com.br/merchant/v1.0/merchants/$merchantId/status",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_HTTPHEADER => [
...
if ($httpCode === 200 && $response) {
    ...
    echo json_encode(['error' => 'Não foi possível obter o status do merchant', 'merchantId' => $merchantId]);
}