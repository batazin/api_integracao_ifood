<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Merchant\Interruption\merchants-merchantId-interruptions.php
...
if ($httpCode === 200 && $response) {
    ...
    echo json_encode(['error' => 'Não foi possível obter as interrupções do merchant', 'merchantId' => $merchantId]);
}