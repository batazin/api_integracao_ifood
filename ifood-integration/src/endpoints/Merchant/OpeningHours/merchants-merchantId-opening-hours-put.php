<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Merchant\OpeningHours\merchants-merchantId-opening-hours-put.php
...
if ($httpCode >= 200 && $httpCode < 300 && $response) {
    ...
    echo json_encode([
        'error' => 'Não foi possível atualizar os horários de funcionamento',
