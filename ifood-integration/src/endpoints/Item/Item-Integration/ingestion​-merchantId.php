<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Item\ingestion-merchantId-patch.php
...
$url = "https://merchant-api.ifood.com.br/item/v1.0/ingestion/$merchantId";
...
if ($httpCode >= 200 && $httpCode < 300) {
    echo $response ?: json_encode([
        'success' => true,
        'message' => 'Catálogo atualizado parcialmente com sucesso!',
        'merchantId' => $merchantId
    ]);
} else {
    http_response_code($httpCode !== 200 ? $httpCode : 500);
    echo json_encode([
        'error' => 'Não foi possível atualizar parcialmente o catálogo',
        'merchantId' => $merchantId,
        'detalhe' => $response
    ]);
}