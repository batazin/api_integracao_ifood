<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Catalog\OptionGroup\merchants-merchantId-optionGroups-optionGroupId-delete.php
...
if ($httpCode >= 200 && $httpCode < 300) {
    echo json_encode([
        'success' => true,
        'message' => 'OptionGroup deletado com sucesso!',
    ...
    echo json_encode([
        'error' => 'Não foi possível deletar o OptionGroup',
        'merchantId' => $merchantId,
        'optionGroupId' => $optionGroupId,
        'detalhe' => $response
    ]);
