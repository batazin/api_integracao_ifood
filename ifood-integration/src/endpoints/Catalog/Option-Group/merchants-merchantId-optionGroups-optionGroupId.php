<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Catalog\OptionGroup\merchants-merchantId-optionGroups-optionGroupId-patch.php
...
$url = "https://merchant-api.ifood.com.br/catalog/v2.0/merchants/$merchantId/optionGroups/$optionGroupId";
...
if ($httpCode >= 200 && $httpCode < 300) {
    echo $response ?: json_encode([
        'success' => true,
        'message' => 'OptionGroup atualizado com sucesso!',
    ...
    echo json_encode([
        'error' => 'Não foi possível atualizar o OptionGroup',
        'merchantId' => $merchantId,
        'optionGroupId' => $optionGroupId,
        'detalhe' => $response
    ]);
