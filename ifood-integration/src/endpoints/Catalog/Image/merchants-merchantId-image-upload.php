<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Catalog\Image\merchants-merchantId-image-upload.php
...
if (!isset($_FILES['file'])) {
    http_response_code(400);
    echo json_encode(['error' => 'Arquivo de imagem não enviado. Use o campo "file" no formulário.']);
    exit;
}

$accessToken = getAccessToken($clientId, $clientSecret);

$url = "https://merchant-api.ifood.com.br/catalog/v2.0/merchants/$merchantId/image/upload";
