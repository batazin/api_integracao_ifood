<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Catalog\Product\merchants-merchantId-products.php
...
$url = "https://merchant-api.ifood.com.br/catalog/v2.0/merchants/$merchantId/products?page=$page&size=$size";
...
if ($httpCode === 200 && $response) {
    ...
    echo json_encode([
        'error' => 'Não foi possível obter os produtos do merchant',
