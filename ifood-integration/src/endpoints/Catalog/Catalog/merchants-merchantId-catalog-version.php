<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Catalog\merchants-merchantId-catalog-version.php
...
$url = "https://merchant-api.ifood.com.br/catalog/v2.0/merchants/$merchantId/catalog/version";
...
if ($httpCode === 200 && $response) {
    ...
    echo json_encode([
        'error' => 'Não foi possível obter a versão do catálogo',
