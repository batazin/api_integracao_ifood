<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Catalog\Inventory\merchants-merchantId-inventory-post.php
...
$url = "https://merchant-api.ifood.com.br/catalog/v2.0/merchants/$merchantId/inventory";
...
if ($httpCode >= 200 && $httpCode < 300) {
    echo $response ?: json_encode([
        'success' => true,
        'message' => 'Inventário atualizado/criado com sucesso!',
        'merchantId' => $merchantId
    ]);
} else {
    http_response_code($httpCode !== 200 ? $httpCode : 500);
    echo json_encode([
        'error' => 'Não foi possível atualizar/criar o inventário',
        'merchantId' => $merchantId,
        'detalhe' => $response
    ]);
}