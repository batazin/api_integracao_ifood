<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Catalog\Inventory\merchants-merchantId-inventory-productId.php
...
$url = "https://merchant-api.ifood.com.br/catalog/v2.0/merchants/$merchantId/inventory/$productId";
...
if ($httpCode === 200 && $response) {
    ...
    echo json_encode([
        'error' => 'Não foi possível consultar o inventário do produto',
