<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Catalog\Category\merchants-merchantId-categories-categoryId-items.php
...
$url = "https://merchant-api.ifood.com.br/catalog/v2.0/merchants/$merchantId/categories/$categoryId/items";
...
if ($httpCode === 200 && $response) {
    ...
    echo json_encode([
        'error' => 'Não foi possível obter os itens da categoria',
