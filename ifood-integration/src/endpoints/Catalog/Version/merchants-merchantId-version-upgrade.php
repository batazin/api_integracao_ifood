<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Catalog\Version\merchants-merchantId-version-upgrade-post.php
...
$url = "https://merchant-api.ifood.com.br/catalog/v2.0/merchants/$merchantId/version/upgrade";
...
if ($httpCode >= 200 && $httpCode < 300) {
    echo $response ?: json_encode([
        'success' => true,
        'message' => 'Upgrade de versão solicitado com sucesso!',
        'merchantId' => $merchantId
    ]);
} else {
    http_response_code($httpCode !== 200 ? $httpCode : 500);
    echo json_encode([
        'error' => 'Não foi possível solicitar o upgrade de versão',
        'merchantId' => $merchantId,
        'detalhe' => $response
    ]);
}