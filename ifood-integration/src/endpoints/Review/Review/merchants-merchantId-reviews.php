<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Catalog\Review\merchants-merchantId-reviews.php
...
$url = "https://merchant-api.ifood.com.br/catalog/v2.0/merchants/$merchantId/reviews";
...
if ($httpCode === 200 && $response) {
    ...
    echo json_encode([
        'error' => 'Não foi possível consultar os reviews',
