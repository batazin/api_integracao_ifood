<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Order\Handshake-Platform\disputes-disputeId-accept.php
...
$ch = curl_init();
curl_setopt_array($ch, [
    CURLOPT_URL => "https://merchant-api.ifood.com.br/order/v1.0/disputes/$disputeId/accept",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_POST => true,
    CURLOPT_HTTPHEADER => [
...
if ($httpCode >= 200 && $httpCode < 300) {
    ...
    echo json_encode([
        'error' => 'Não foi possível aceitar a disputa',
        'disputeId' => $disputeId,
        'detalhe' => $response
    ]);
}