<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Order\Actions\orders-id-cancellationReasons.php
...
$ch = curl_init();
curl_setopt_array($ch, [
    CURLOPT_URL => "https://merchant-api.ifood.com.br/order/v1.0/orders/$orderId/cancellationReasons",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_HTTPHEADER => [
