<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Order\Details\orders-id-virtual-bag.php
...
$ch = curl_init();
curl_setopt_array($ch, [
    CURLOPT_URL => "https://merchant-api.ifood.com.br/order/v1.0/orders/$orderId/virtual-bag",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_HTTPHEADER => [
...
if ($httpCode === 200 && $response) {
    ...
    echo json_encode([
        'error' => 'Não foi possível obter a virtual bag do pedido',
        'orderId' => $orderId,
        'detalhe' => $response
    ]);
}