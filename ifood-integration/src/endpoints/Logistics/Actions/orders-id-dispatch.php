<?php
// filepath: c:\WF\api_integracao_ifood\ifood-integration\src\endpoints\Logistics\Actions\orders-id-dispatch.php
...
$ch = curl_init();
curl_setopt_array($ch, [
    CURLOPT_URL => "https://merchant-api.ifood.com.br/logistics/v1.0/orders/$orderId/dispatch",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_POST => true,
    CURLOPT_HTTPHEADER => [
...
if ($httpCode >= 200 && $httpCode < 300) {
    ...
    echo json_encode([
        'error' => 'Não foi possível despachar o pedido',
        'orderId' => $orderId,
        'detalhe' => $response
    ]);
}